...
Global $payButtonNN = "TPDJButton3"
...
Local $hnrTabX = 328
Local $hnrTabY = 29
Local $classicPepperoniX = 480
Local $classicPepperoniY = 287
...
Local $specialsTabY = 132
Local $makeItAMealX = 162
...
Local $futureDayX = 484
Local $futureDayY = 352

Local $futureTimeX = 829
Local $futureTimeY = 217
...
;Automation Start:
While noErrors()
   waitingOrder(3, "hnr", "cash", 1, 0, 0)
   waitingOrder(3, "spec", "cash", 0, 1, 0)
   waitingOrder(3, "hnr+spec", "cash", 1, 1, 0)
   queueOrder(1, "hnr", "cash", 1, 0, 0)
   queueOrder(1, "spec", "cash", 0, 1, 0)
   queueOrder(1, "hnr+spec", "cash", 1, 1, 0)
   scheduleOrder(3, "hnr", "cash", 1, 0, 0)
   scheduleOrder(3, "spec", "cash", 0, 1, 0)
   scheduleOrder(3, "hnr+spec", "cash", 1, 1, 0)
   prepaidOrder(3, "hnr", "cash", 1, 0, 0)
   ;RECOMMENDEDSALES()
WEnd
